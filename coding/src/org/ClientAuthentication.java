...
public class ClientAuthentication {
	...
	public static void my() throws Exception{
		...
		CloseableHttpClient httpClient=HttpClients.custom().setDefaultCredentialsProvider(credsProvider).build();
		HttpGet httpGet=new HttpGet("https://djrcfeed.dowjones.com/SanctionAlert/CitiesandPorts/xml/Feedlogs/checksum_DJRC_Cities_and_Ports_XML_201806122359_S.txt");
		...
		try{
			...
			entity.writeTo(new FileOutputStream(new File("C:\\Users\\13552\\Desktop\\checksum_DJRC_Cities_and_Ports_XML_201806122359_S.txt")));
//			String entities=EntityUtils.toString(response.getEntity());
//			String str=new String(entities.getBytes(),"utf-8");
